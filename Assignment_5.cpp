...
public:
    ...
    void display(Node *);
    void display_level();
    void display_parent_child_nodes(Node *);
...
void BST::display_parent_child_nodes(Node *root)
{
    if (root == NULL)
        return;
    else
    {
        display_parent_child_nodes(root->left);
        ...
        display_parent_child_nodes(root->right);
    }
}

void BST::display_leaf_nodes(Node *root)
{
    if (root == NULL)
        return;
    else
...
int main()
{
    ...
    while (1)
    {
        ...
        cout << "\n9. Display Parent Nodes with Child Nodes.";
        cout << "\n10. Exit.";
        cout << "\nEnter your choice: ";
        cin >> choice;
        ...
        case 8:
            cout << "\nLeaf Nodes: ";
            tree.display_leaf_nodes(tree.getroot());
            break;

        case 9:
            cout << "\nParent Nodes with Child Nodes: ";
            tree.display_parent_child_nodes(tree.getroot());
            break;
